<div align="center">
  ...
  <p>
    <a href="https://github.com/zzliu93-debug/lsland-1/releases/latest">下载 Release</a>
    ·
    <a href="https://github.com/zzliu93-debug/lsland-1/issues">反馈 Issue</a>
    ·
    <a href="#路线图">查看路线图</a>
  </p>
...
1. 打开本仓库的 [GitHub Releases](https://github.com/zzliu93-debug/lsland-1/releases/latest) 页面。
...
```text
src-tauri/target/release/bundle/nsis/FocuSD Island_0.1.4_x64-setup.exe
src-tauri/target/release/bundle/msi/FocuSD Island_0.1.4_x64_en-US.msi
```
